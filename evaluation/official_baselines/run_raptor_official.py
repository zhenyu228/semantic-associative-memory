...
def AzureEmbeddingModel(BaseEmbeddingModel, model: str, api_key: str, azure_endpoint: str, api_version: str):
    class _AzureEmbeddingModel(BaseEmbeddingModel):
        ...
        def create_embedding(self, text):
            text = text.replace("\n", " ")
            return _embedding(self.client, self.model, text)
...
def _embedding(client, model: str, text: str) -> list[float]:
    response = _post_azure(
        client=client,
        deployment=model,
        endpoint="embeddings",
