...
SAM_AZURE_EMBEDDING_ENDPOINT=https://search-va.byteintl.net/gpt/openapi/online/v2/crawl
...
SAM_AZURE_EMBEDDING_CONCURRENCY=10
SAM_AZURE_EMBEDDING_BATCH_SIZE=16
SAM_AZURE_EMBEDDING_API_KEY=replace-with-embedding-api-key

SAM_CHAT_PROVIDER=azure_openai
SAM_AZURE_CHAT_ENDPOINT=https://aidp-i18ntt-sg.byteintl.net/api/modelhub/online/v2/crawl
