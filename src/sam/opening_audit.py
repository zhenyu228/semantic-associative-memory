...
OPENING_MODULE_SPECS: list[ModuleSpec] = [
    ...
    ModuleSpec(
        ...
        experiment_evidence=[
            ...
            EvidenceSpec("HotpotQA 300 条真实 embedding 主实验", "outputs/runs/hotpotqa300_real_embedding_main_v4_hops1/metrics.json", "experiment"),
            EvidenceSpec("NovelQA 12 条真实 embedding smoke", "outputs/runs/novelqa12_real_embedding_query_plan_v1/metrics.json", "experiment"),
        ],
        remaining_work=[
    ...
    ModuleSpec(
        ...
        experiment_evidence=[
            ...
            EvidenceSpec("真实 embedding 类比复用 30 条", "outputs/runs/analogy_reuse_hotpotqa30_real_embedding_v2/analogy_reuse_results.json", "experiment"),
            EvidenceSpec("GPT-5.4 共享记忆与类比生成对照 10 条", "outputs/runs/agent_generation_gpt54_q10_real_embedding_v1/agent_generation_comparison.json", "experiment"),
        ],
        remaining_work=[
    ...
    ModuleSpec(
        ...
        experiment_evidence=[
            ...
            EvidenceSpec("多智能体 workflow 审计", "outputs/runs/agent_workflow_audit_smoke/agent_workflow_audit.json", "experiment"),
            EvidenceSpec("GPT-5.4 多智能体生成对照 10 条", "outputs/runs/agent_generation_gpt54_q10_real_embedding_v1/agent_generation_comparison.json", "experiment"),
        ],
        remaining_work=[
